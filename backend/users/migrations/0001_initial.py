    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[users.models.validate_user_name], verbose_name='Уникальное имя пользователя')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('username', 'email'), name='users_userfoodgram_name_unique'),
        ),
    ]
